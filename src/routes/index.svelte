				...
				<div class="h-1/5 px-4 pt-4 text-center flex justify-center items-center">
					<div>
						...
						<div class="flex justify-center items-center ml-8">
							...
							<button class="bg-white mt-1 bg-blue-400 hover:bg-gray-600 text-gray-800 font-medium ml-6 p-2 rounded-full drop-shadow-lg inline-flex items-center justify-center" on:click={() => openModal(CaptureModal, { diaryTitle: diaryTitle, diaryContent: diaryContent, keywordPhrases: recommendedKeywordPhrase, nextPhrases: recommendedPhrase })}>
